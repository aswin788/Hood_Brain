            ...
            <form action="scripts/register.php" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="city" id="city">
                      <option value="null">Enter your city..</option>
                ...
                <div class="form-group">
                    ...
                    <textarea name="descr" id="descr" class="form-control" cols="30" rows="5"
                        placeholder="Something about yourself..." required></textarea>
                </div>

                <div class="form-group">
                    <label for="">Password</label>
                    <input id="password" name="password" type="password" class="form-control"
                        placeholder="Password must be 6 characters long" minlength="4" required>
                </div>

                <div class="form-group">
                    <label for="">Profession</label>
                    <select class="form-control" name="profession" id="profession">
                      <option value="null">Enter your Profession....</option>
