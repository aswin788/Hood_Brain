    ...
    <div class="card">
        <div class="card-body">
            <div class="card-title">
                <b><h2 class="text-center">Book A Service from <?= $provider->name; ?>
                </h2></b>
            </div>
            <hr>
            ...
            <form action="scripts/bookhall.php" method="post">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="payment" id="payment" required>
                        <option value="null">Enter Payment Method..</option>
