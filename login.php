...
<div class="container" style="margin-top: 50px; width: 450px;">
    <div class="card">
        <img src="./images/pros.jpg" style="height: 160px; width: 200px; margin-left: 100px" class="card-img-top"
            alt="icon">
        <div class="card-body">
            ...
            <form action="scripts/login.php" method="post">
                ...
                <div class="form-group">
                    ...
                    <input id="password" name="password" type="password" class="form-control"
                        placeholder="Password Must Contain Minimum 4 Characters" minlength="4" required>
                </div>
